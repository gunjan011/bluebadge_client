    ...
    render() {
        return (
            <div classname="writingtips">
                ...
                <li>Know your purpose: Why are you writing a poem and what do you want it to say?</li>
                <li>Pick a subject: You do not have to pick a stereotypical topic such as nature, 
                    animals, love, or something dark, like death or fear. 
                    Poems can be written about any topic under the sun.</li>
                <li>Choose a pattern: You might choose to use free verse or rhyming couplets.
                    The more you write in one form, the more naturally your prose will fall into that mold.</li> 
                <li>Avoid clichés: Clichés are sayings that have been overused, 
                    like "busy as a bee," or "blind as a bat."</li>  
                <li>Use imagery: Use concrete words that appeal to the senses. 
                    Abstract words will not offer the reader a firm picture of what you're trying to say.</li> 
                <li>Use similes and metaphors: Similes compare two things and usually use the word "like" or "as."
